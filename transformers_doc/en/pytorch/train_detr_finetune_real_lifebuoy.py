...
checkpoint = "ARG-NCTU/detr-resnet-50-finetuned-100-epochs-lifebuoy-dataset"
...
training_args = TrainingArguments(
    output_dir="detr-resnet-50-finetuned-100-epochs-real-lifebuoy-dataset",
    ...
    push_to_hub=True,
    hub_model_id="ARG-NCTU/detr-resnet-50-finetuned-100-epochs-real-lifebuoy-dataset",
)
...
trainer.push_to_hub(commit_message='detr-resnet-50-finetuned-real-lifebuoy-dataset 100 epoch')
...
def eval(eval_dataset, mode="val"):
    im_processor = AutoImageProcessor.from_pretrained("ARG-NCTU/detr-resnet-50-finetuned-100-epochs-real-lifebuoy-dataset")
    ...
    model = AutoModelForObjectDetection.from_pretrained("ARG-NCTU/detr-resnet-50-finetuned-100-epochs-real-lifebuoy-dataset")
...
image_processor = AutoImageProcessor.from_pretrained("ARG-NCTU/detr-resnet-50-finetuned-100-epochs-real-lifebuoy-dataset")
model = AutoModelForObjectDetection.from_pretrained("ARG-NCTU/detr-resnet-50-finetuned-100-epochs-real-lifebuoy-dataset").to(device)
